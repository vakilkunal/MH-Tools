    ...
    series: [
      {
        ...
        phase: utils.genVarField('stage', [
          'Acolyte', 'Ancient Lab', 'Entrance', 'Frozen Alcove', 'Furnace Room', 'Gearworks', 'Guard Barracks',
          'Hidden Treasury', 'Ingress', 'Lucky Tower', 'Pursuer Mousoleum', 'Runic Laboratory', 'Security', 'Timewarp'
        ]),
        cheese: utils.genVarField('cheese', [
          'Runic String', 'Ancient String', 'Magical String', 'Brie String', 'Swiss String'
        ]),
        charm: [
          { vars: { charm: { 'Rift Antiskele': false } } },
          { vars: { charm: { 'Rift Antiskele': true } }, fields: { charm: 'Rift Antiskele' } }
        ]
      }
    ],
