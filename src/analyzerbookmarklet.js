javascript:void(function() {
    ...
    var entriesNum = Math.ceil(entriesSlice/10);
    var counter = 0;
    ...
    var interval = setInterval(function() {
        ...
        if (a.className.indexOf("disabled") < 0 || parseInt(document.querySelector("div.history-details .paginate_button.current").innerHTML) == entriesNum) {
