(function () {
    ...
    var csvConverter = csv({
        headers: ["location", "phase", "cheese", "charm", "attraction", "mouse", "sampleSize"],
        colParser: {
            'attraction' : 'Number',
            'sampleSize' : 'Number'
        }
    ...
    function saveFiles() {
        ...
        fileUtils.saveJsonFile("data/pretty/populations-cre.json", crePopulations, 4);
        fileUtils.saveJsonFile("data/pretty/populations-map.json", mapPopulations, 4);
        fileUtils.saveJsonFile("data/pretty/populations-setup.json", setupPopulations, 4);
    }
